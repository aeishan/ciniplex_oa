...
const TextCustomizer = ({colours, fontSizes, fonts}) => {
    useEffect(() => {
        ...
        // document.documentElement.style.setProperty("--days-number-font", fontSizes.daysNumFont);  
        // document.documentElement.style.setProperty("--days-label-font", fontSizes.daysLabelFont);
        ...
        // fonts.daysLabelFont, fonts.hoursLabelFont, fonts.minutesLabelFont, fonts.secondsLabelFont
    ]);
